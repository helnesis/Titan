...
public sealed record FormInputValue(
    [property: JsonPropertyName("input_id")] string InputId,
...
public sealed record LoginResult(
    [property: JsonPropertyName("authentication_state")] AuthenticationState AuthenticationState,
    [property: JsonPropertyName("error_code")] string ErrorCode,
    [property: JsonPropertyName("error_message")] string ErrorMessage,
    [property: JsonPropertyName("url")] string Url,
    [property: JsonPropertyName("login_ticket")] string LoginTicket,
    [property: JsonPropertyName("server_evidence_m2")] string ServerEvidenceM2,
