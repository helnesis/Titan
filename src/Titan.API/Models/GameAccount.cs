...
public sealed record GameAccountInfo(
    ...
    [property: JsonPropertyName("expansion")] int Expansion,
    [property: JsonPropertyName("is_suspended")] bool IsSuspended = false,
    [property: JsonPropertyName("is_banned")] bool IsBanned = false,
    [property: JsonPropertyName("suspension_expires")] long? SuspensionExpires = -1,
