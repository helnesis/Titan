...
internal static class ItemQueries
{
    ...
    public const string InsertOrUpdateItemAppearance = """
                                                       INSERT INTO item_appearance (ID, DisplayType, ItemDisplayInfoID, DefaultIconFileDataID, UiOrder, PlayerConditionID)
                                                           VALUES (@ID, @DisplayType, @ItemDisplayInfoID, @DefaultIconFileDataID, @UiOrder, @PlayerConditionID)
                                                           ON DUPLICATE KEY UPDATE ID = @ID, DisplayType = @DisplayType, ItemDisplayInfoID = @ItemDisplayInfoID, DefaultIconFileDataID = @DefaultIconFileDataID, UiOrder = @UiOrder, PlayerConditionID = @PlayerConditionID
    ...
    public const string InsertOrUpdateItemModifiedAppearance = """
                                                               INSERT INTO item_modified_appearance (ID, ItemID, ItemAppearanceModifierID, ItemAppearanceID, OrderIndex, TransmogSourceTypeEnum, Flags)
                                                                   VALUES (@ID, @ItemID, @ItemAppearanceModifierID, @ItemAppearanceID, @OrderIndex, @TransmogSourceTypeEnum, @Flags)
                                                                   ON DUPLICATE KEY UPDATE ID = @ID, ItemID = @ItemID, ItemAppearanceModifierID = @ItemAppearanceModifierID, ItemAppearanceID = @ItemAppearanceID, OrderIndex = @OrderIndex, TransmogSourceTypeEnum = @TransmogSourceTypeEnum, Flags = @Flags
    ...
    public const string InsertOrUpdateItemModifiedAppearanceExtra = """
                                                                    INSERT INTO item_modified_appearance_extra (ID, IconFileDataID, UnequippedIconFileDataID, SheatheType, DisplayWeaponSubclassID, DisplayInventoryType)
                                                                        VALUES (@ID, @IconFileDataID, @UnequippedIconFileDataID, @SheatheType, @DisplayWeaponSubclassID, @DisplayInventoryType)
                                                                        ON DUPLICATE KEY UPDATE ID = @ID, IconFileDataID = @IconFileDataID, UnequippedIconFileDataID = @UnequippedIconFileDataID, SheatheType = @SheatheType, DisplayWeaponSubclassID = @DisplayWeaponSubclassID, DisplayInventoryType = @DisplayInventoryType
    ...
    public const string InsertOrUpdateItemNameDescription = """
                                                            INSERT INTO item_name_description (ID, Description, Color)
                                                                VALUES (@ID, @Description, @Color)
                                                                ON DUPLICATE KEY UPDATE ID = @ID, Description = @Description, Color = @Color
    ...
    public const string InsertOrUpdateItemNameDescriptionLocale = """
                                                                  INSERT INTO item_name_description_locale (ID, locale, Description_lang)
                                                                      VALUES (@ID, @locale, @Description_lang)
                                                                      ON DUPLICATE KEY UPDATE ID = @ID, locale = @locale, Description_lang = @Description_lang
    ...
    public const string InsertOrUpdateItemSparseLocale = """
                                                         INSERT INTO item_sparse_locale (ID, locale, Description_lang, Display3_lang, Display2_lang, Display1_lang, Display_lang)
                                                             VALUES (@ID, @locale, @Description_lang, @Display3_lang, @Display2_lang, @Display1_lang, @Display_lang)
                                                             ON DUPLICATE KEY UPDATE ID = @ID, locale = @locale, Description_lang = @Description_lang, Display3_lang = @Display3_lang, Display2_lang = @Display2_lang, Display1_lang = @Display1_lang, Display_lang = @Display_lang
