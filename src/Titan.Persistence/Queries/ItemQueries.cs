...
internal static class ItemQueries
{
    ...
    public const string InsertOrUpdateItemNameDescriptionLocale = """
                                                                  INSERT INTO item_name_description_locale (Id, locale, Description_lang)
                                                                      VALUES (@Identifier, @locale, @DescriptionLang)
                                                                      ON DUPLICATE KEY UPDATE Id = @Identifier, locale = @locale, Description_lang = @DescriptionLang
    ...
    public const string InsertOrUpdateItemSparseLocale = """
                                                         INSERT INTO item_sparse_locale (Id, locale, Description_lang, Display3_lang, Display2_lang, Display1_lang, Display_lang)
                                                             VALUES (@Identifier, @locale, @DescriptionLang, @Display3Lang, @Display2Lang, @Display1Lang, @DisplayLang)
                                                             ON DUPLICATE KEY UPDATE locale = @locale, Description_lang = @DescriptionLang, Display3_lang = @Display3Lang, Display2_lang = @Display2Lang, Display1_lang = @Display1Lang, Display_lang = @DisplayLang
    ...
    public const string GetNextItemNameDescriptionId = "SELECT MAX(Id) + 1 FROM item_name_description";
